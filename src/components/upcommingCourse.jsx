	...
	return (
		<div className="container mx-auto px-8 py-8 ">
			<div className="lg:flex justify-between items-center text-left  lg:pt-10 pt-0 pb-10">
				<div>
					<h1 className="font-bold text-xl lg:text-4xl text-primary">Upcoming Courses</h1>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
				{
					courses.map((course) => (
						<Card className="w-full rounded-2xl overflow-hidden pt-5 bg-cyan-400 transition-all duration-300 hover:shadow-xl"
							key={course._id}
							course={course}
						>
								...
								<CardContent className=" p-4 bg-white">
									...
									<div className="flex gap-3 mt-4">
										...
										<Image
											...
											src={course.instructor.image || '/assets/custom-image/default-author.jpg'}
											alt="Author Image"
											width={50}
											height={50}
										></Image>
									...
									<p className="mt-3 mb-3 text-gray-500 text-md">{course.instructor.profession}</p>
