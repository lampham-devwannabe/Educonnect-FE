...
<p className='text-gray-300 lg:text-lg text-sm mt-3 lg:leading-7 md:leading-7'>
  Be among the first 100 to grab this exclusive deal and save 40% on your purchase. 
  Don’t miss out—once the slots are gone, the offer ends! 🚀
</p>


							<div className='flex flex-col w-fit lg:flex-row gap-5 lg:mt-10 mt-5'>
								<Link href='/about'>
									<Button className=' h-8 lg:h-full bg-[--primary] p-0 rounded-full hover:bg-[--primary]  hover:text-white  text-white '><span className=' lg:py-2 pl-5'>Join With Us </span><ArrowRight className=' w-fit lg:w-full h-7 lg:h-full text-sm p-1.5 lg:p-2.5 bg-[#644BFF] rounded-full ml-3' /></Button>
								</Link>
								<Link href='/courselist'>
									<Button className='h-8 lg:h-full bg-[--secondary] p-0 rounded-full hover:bg-[--secondary]  hover:text-white  text-white '><span className='py-2 pl-5'>Our Courses </span><ArrowRight className=' w-fit lg:w-full h-7 lg:h-full text-sm p-1.5 lg:p-2.5 bg-[--secondary-foreground] rounded-full ml-3' /></Button>
								</Link>
							</div>
						...
						<div className="absolute lg:right-[30%] right-[50%] bottom-[16%] lg:bottom-[44%]">
							<Link className="my-video-links"
								data-autoplay="true"
								data-vbtype="video"
								href="https://youtu.be/6lwh_jfLn2g">
