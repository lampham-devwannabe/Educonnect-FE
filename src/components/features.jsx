					...
					<div className="relative ">
						...
						<div className="lg:absolute bg-white py-8 px-5 w-full lg:w-80 rounded-br-2xl rounded-bl-2xl lg:rounded-2xl right-12 -top-10">
							...
							<p className="mt-3 mb-5 text-gray-500 leading-7">
								...
								accountability. If you manage a ded virtual team today, then
								you will for the rest of your career. probably for the rest of
								your career. continue for the rest of your career.
							</p>
