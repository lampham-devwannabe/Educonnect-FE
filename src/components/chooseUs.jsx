        ...
        <div className='container flex flex-col lg:flex-row items-center mt-2 lg:mt-20 mb-10'>
            <div className='relative lg:pr-24 lg:mt-0 mt-5'>
                ...
                <div className="lg:block hidden absolute top-20 -left-3">
                    <Image className='w-40 h-12' alt='' width={400} height={300} src={textCircle}></Image>
                </div>
                <InfoTitle
                ...
                <div className="flex flex-wrap gap-4 lg:mt-7">
                    <div className='bg-gray-50 p-3 rounded-md w-full sm:w-[48%]'>
                        <h5 className='text-md text-gray-600 font-bold flex items-center mb-3'><CheckCircle2 className='w-4 h-4 mr-1 text-[--primary] '></CheckCircle2> World className Trainers</h5>
                        <p className='text-sm text-gray-500'>Suspendisse ultrice gravida dictum
                            fusce placerat ultricies integer quis
                            auctor elit sed vulputate mi sit.</p>
                    </div>
                    <div className='bg-gray-50 p-3 rounded-md w-full sm:w-[48%]'>
                        <h5 className='text-md text-gray-600 font-bold flex items-center mb-3'><CheckCircle2 className='w-4 h-4 mr-1 text-[--primary] '></CheckCircle2> Easy Learning</h5>
                        <p className='text-sm text-gray-500'>Suspendisse ultrice gravida dictum
                            fusce placerat ultricies integer quis
                            auctor elit sed vulputate mi sit.</p>
                    </div>
                    <div className='bg-gray-50 p-3 rounded-md w-full sm:w-[48%]'>
                        <h5 className='text-md text-gray-600 font-bold flex items-center mb-3'><CheckCircle2 className='w-4 h-4 mr-1 text-[--primary] '></CheckCircle2> Flexible</h5>
                        <p className='text-sm text-gray-500'>Suspendisse ultrice gravida dictum
                            fusce placerat ultricies integer quis
                            auctor elit sed vulputate mi sit.</p>
                    </div>
                    <div className='bg-gray-50 p-3 rounded-md w-full sm:w-[48%]'>
                        <h5 className='text-md text-gray-600 font-bold flex items-center mb-3'><CheckCircle2 className='w-4 h-4 mr-1 text-[--primary] '></CheckCircle2> Affordable Price</h5>
                        <p className='text-sm text-gray-500'>Suspendisse ultrice gravida dictum
                            fusce placerat ultricies integer quis
                            auctor elit sed vulputate mi sit.</p>
                    </div>
