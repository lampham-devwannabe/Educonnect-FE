    ...
    <footer className="bg-[#151339] text-white mt-5 lg:mt-20">
      <div className="container mx-auto py-12 px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-300">Fusce varius, dolor tempor interdum tristique bibendum.</p>
          ...
          <div className="flex items-center gap-3 text-sm">
            ...
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=smartacademyinfo@gmail.com" target="_blank">
          ...
          <div className="flex gap-4 pt-2">
            <a target="_blank" href="https://www.facebook.com/share/1F2MGc59HE/?mibextid=qi2Omg" className="text-white hover:text-gray-300">
              <Facebook size={18} />
            </a>
            <a target="_blank" href="https://www.linkedin.com/company/arcadexit/" className="text-white hover:text-gray-300">
              <Linkedin size={18} />
            </a>
            <Link href="#" className="text-white hover:text-gray-300">
              <Instagram size={18} />
            </Link>
            <a target="_blank" href="https://www.youtube.com/@ArcadexIT" className="text-white hover:text-gray-300">
              <Youtube size={18} />
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <Link href="/courselist" className="flex items-center gap-2 text-sm hover:text-gray-300">
                <ArrowRight size={16} />
            ...
            <li>
              <Link href="/popular-post" className="flex items-center gap-2 text-sm hover:text-gray-300">
                <ArrowRight size={16} />
